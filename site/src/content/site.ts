 ...
 */
import developersArtwork from "../../public/media/brand/developers.png";

import { DEVELOPER_ALT, DEVELOPER_PARTIES } from "./developer-lockup.generated";
 ...
 */
/**
 * Width and height come from the file itself through Next's static image
 * import, not from numbers typed here. The lockup is generated by
 * `tools/build-developer-lockup.py` and changes shape whenever a party is
 * added, so hard-coded dimensions would silently distort the marks the next
 * time it is rebuilt.
 */
export const developerLockup = {
  src: developersArtwork.src,
  width: developersArtwork.width,
  height: developersArtwork.height,
  alt: DEVELOPER_ALT,
  /** In the order the artwork sets them. */
  parties: DEVELOPER_PARTIES,
} as const;

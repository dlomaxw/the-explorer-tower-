          ...
          */}
          <div className="flex flex-wrap items-center justify-between gap-4 text-xs text-stone-500">
            ...
            <ul className="flex flex-wrap gap-5">
              ...
              <li>
                {/*
                  A plain anchor, not next/link: /sitemap.xml is generated by a
                  route handler rather than being a page in the router, so the
                  client-side navigation Link would attempt has nothing to go to.
                */}
                <a href="/sitemap.xml" className="hover:text-stone-300">
                  Sitemap
                </a>
              </li>
            </ul>
